...
LOCAL_MODULE := android.hardware.power@1.0-service.onyx
LOCAL_INIT_RC := android.hardware.power@1.0-service.onyx.rc
LOCAL_SHARED_LIBRARIES += android.hardware.power@1.0
LOCAL_CFLAGS += -DV1_0_HAL
else
LOCAL_MODULE := android.hardware.power@1.1-service.onyx
LOCAL_INIT_RC := android.hardware.power@1.1-service.onyx.rc
