...
public class OnyxDozeService extends Service {
    private static final String TAG = "OnyxDozeService";
    ...
    private OnyxProximitySensor mSensor;
    ...
    class OnyxProximitySensor implements SensorEventListener {
        ...
        public OnyxProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "OnyxDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new OnyxProximitySensor(mContext);
        mWakeLock = mPowerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "OnyxDozeWakeLock");
